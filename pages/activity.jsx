...
//     <div className="min-h-screen bg-gray-50">
//       <Head>
//   <title>Adventure Activities – Trekking, Paragliding, Rafting & More | Desire4Travels</title>
//   <meta
//     name="description"
//     content="Discover thrilling adventure activities with Desire4Travels, including trekking, rafting, paragliding, scuba diving, and more. Plan your adrenaline-packed journey today!"
//   />
//   <meta
//     name="keywords"
//     content="adventure activities, trekking, paragliding, bungee jumping, rafting, scuba diving, camping, flying fox, giant swing, igloo camping, outdoor adventures, thrill-seeking trips, India adventure travel, Desire4Travels"
//   />
//   <meta name="author" content="Desire4Travels" />
//   <meta
//     property="og:title"
//     content="Adventure Activities – Trekking, Paragliding, Rafting & More | Desire4Travels"
//   />
//   <meta
//     property="og:description"
//     content="Experience adrenaline-packed adventures across India with Desire4Travels. Explore top-rated activities like trekking, rafting, bungee jumping, and more with expert guides."
//   />
...
//         <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
//           {activities.map((activity) => (
//             <div key={activity.id} className="bg-white rounded-lg shadow-lg overflow-hidden transition-transform duration-300 hover:scale-105 hover:shadow-xl">
...
//               <div className="p-6">
//                 <Link href={`/activity/${activity.slug}`} passHref>
//                   <h2 className="text-xl font-semibold text-gray-800 mb-2 hover:text-blue-600">{activity.title}</h2>
//                 </Link>
//                 <p className="text-gray-600 mb-4">{activity.description}</p>
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <Head>
        ...
        />
        <meta name="author" content="Desire4Travels" />
        <meta property="og:title" content="Adventure Activities – Trekking, Paragliding, Rafting & More | Desire4Travels" />
        <meta property="og:description" content="Experience adrenaline-packed adventures across India with Desire4Travels. Explore top-rated activities like trekking, rafting, bungee jumping, and more with expert guides." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://www.desire4travels.com/activities" />
      </Head>
